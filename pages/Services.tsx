...
const Services: React.FC = () => {
  usePageMeta(
    'Our Services | RexJagers Executive Search',
    'Explore our signature services including executive search, leadership consulting, talent mapping, and board advisory, designed to build your organization\'s leadership foundation.'
  );
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            {SERVICES.map((service, index) => (
              ...
              >
                ...
                <div>
                  <h2 className="text-2xl font-bold text-navy dark:text-white mb-2">{service.title}</h2>
