...
const JobOpening: React.FC<{ opening: CareerOpeningType }> = ({ opening }) => {
    ...
    return (
        <div className="bg-light-slate dark:bg-dark-bg-section p-6 border border-navy/15 dark:border-slate/30 rounded-lg shadow-sm">
            ...
            >
                <div className="mt-4 pt-4 border-t border-slate/50 text-gray-700 dark:text-slate-light">
                    <p className="mb-4">{opening.description}</p>
                    <h4 className="font-semibold text-navy dark:text-white mb-2">Key Requirements:</h4>
...
const Careers: React.FC = () => {
  ...
  useSEO({
    title: 'Career Opportunities | RexJagers Executive Search',
    description: 'Join the RexJagers team. Explore current openings for consultants, research analysts, and associates dedicated to shaping the future of leadership.',
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          {CAREER_OPENINGS.length > 0 ? (
            ...
            <div className="text-center bg-light-slate dark:bg-dark-bg-section p-8 border border-navy/15 dark:border-slate/30 rounded-lg">
              ...
              <p className="mt-2 text-gray-700 dark:text-slate-light">
