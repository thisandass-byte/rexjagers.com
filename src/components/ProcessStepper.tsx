...
import { PROCESS_STEPS } from '../lib/schema.ts';
  ...
  return (
    <div className="container mx-auto px-6">
      <div className="text-center mb-16">
        ...
        <p className="max-w-3xl mx-auto text-navy dark:text-slate-light mt-4">
        ...
        >
          {PROCESS_STEPS.map((step, index) => (
            <motion.div key={index} variants={itemVariants} className="min-h-[100px]">
              ...
              <p className="text-navy dark:text-slate-light">{step.description}</p>
            </motion.div>
          ))}
        </motion.div>
