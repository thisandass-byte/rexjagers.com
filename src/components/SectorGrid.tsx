    ...
    return (
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 max-w-2xl mx-auto text-navy dark:text-slate-light">Deep domain knowledge across primary verticals to ensure we understand your unique challenges.</p>
          </div>
          <motion.div
